...
### [SenkyoWatch](https://senkyo.watch) (2021 – Present)  

SenkyoWatch is the only service in Japan that provides real-time list of candidates with full changelogs and functionality for guessing election results, with beautiful geographic visualization. More than 1,000 core users enjoy the service often, and more than 1,000,000 people visit the site during major elections. Built with Next.js and Firebase, tuned for high speed and scalability with Cloudflare Workers.
...
- **Frameworks and Tools:** React, Next.js, Vite, Firebase, Google Cloud  
- **Databases:** Firestore, MongoDB, SQLite  
- **Development Environments:** macOS, iOS, Linux, Git  

### Familiar With

- PyTorch, Swift, AWS, Windows
